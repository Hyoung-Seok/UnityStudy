...
public class FollowTargetController : MonoBehaviour
{
    ...
    private void LateUpdate()
    {
        ...
        {
            _targetRotation = new Vector3(targetEuler.x > _pitchLimitMax ? targetEuler.x - 360.0f : targetEuler.x,
                targetEuler.y, targetEuler.z);
        }
        else
        {
            {
    ...
    {
        float result = eulerAngle - Mathf.Ceil(eulerAngle / 360f) * 360f;
